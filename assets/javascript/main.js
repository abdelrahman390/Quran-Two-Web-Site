...
if (currentPageNameForMainPAgeNested[currentPageNameForMainPAgeNested.length - 2] === 'new-registration') {
...
if (currentPageName === 'map.html') {
    ...
    // var map = L.map("map").setView([24.2669, 45.1078], 5);
    var map = L.map("map").setView([22.2954496, 50.6793759], 5);

    L.tileLayer("https://tile.openstreetmap.org/{z}/{x}/{y}.png", {
        attribution: "© OpenStreetMap",
    }).addTo(map);

    // var marker = new L.marker([24.2669, 45.1078], {
    var marker = new L.marker([22.2954496, 50.6793759], {
        draggable: true,
        autoPan: true,
    }).addTo(map);
