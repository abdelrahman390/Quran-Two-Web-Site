...
if (currentPageName === 'Frequently-Asked-Questions.html') {
    ...
    Frequently - Asked - QuestionsBoxes.forEach((element, index) => {
        ...
        element.onclick = (e) => {
            ...
            if (!(e.currentTarget.classList.contains('checked'))) {
                ...
                // console.log(Frequently-Asked-QuestionsExpandedText[0])
                e.currentTarget.classList.add("checked")
...
if (currentPageName === 'account.html' || 'account-subscription.html' || 'account-new-password.html') {
